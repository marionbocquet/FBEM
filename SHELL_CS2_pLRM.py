...
r_s = 0.002 # snow grain size (normal range from 0.0001 to 0.004 m, default 1 mm)
...
bandwidth = 320*10e6 # antenna bandwidth (default = 320*10**6 Hz, e.g. Cryosat-2)
...
dx = 20 # resolution of grid, m (WARNING use dx>=10 for PL mode and dx>=5 for SAR mode)
